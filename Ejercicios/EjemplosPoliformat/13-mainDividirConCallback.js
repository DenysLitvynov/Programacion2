...
//------------------------------------------------
// node 01-mainDividirConCallbacks.js
//------------------------------------------------
...
//llamada con un callback diferente

dividir2(x,y,function(error,resultado){
	if (error) {
		console.log( "la division falló: " + (x/0.00000000000001) )
		return
	}
