...
//
function substituir(array,num1,num2,funcion){
    return array.map(function(elem){ funcion(elem,num1,num2); });
}// ()
...
function probarSubstituir(array,num1,num2,arrayPrueba){
    const arrayRes = probarSubstituir(array, function(elem,num1,num2){
        if(elem == num1){
            return elem = num2;
        }
        return elem;
